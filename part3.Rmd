...
- This was run on a `r system("cat /proc/cpuinfo | grep 'model name' | tail -1 | awk -F: '{ print $2 } '")`, and  took **`r round(elapsed.time,2)` seconds** for `r counties.to.query` counties. 
